...
This ensures agents cannot consume resources beyond their budget.`,category:"Security",tags:["fuel","governance"]},{id:"k-3",title:"Autonomy Levels L0-L5",content:"L0 Inert → L1 Suggest → L2 Act-with-approval → L3 Act-then-report → L4 Autonomous-bounded → L5 Full autonomy. Most agents start at L1-L2. Promotion requires demonstrated track record. The kernel can always override.",category:"Getting Started",tags:["autonomy","governance"]},{id:"k-4",title:"Speculative Execution Engine",content:"Before a Tier2+ action is approved, the kernel runs it speculatively in a shadow context. This 'what-if' simulation shows exactly what would happen without committing. If approved: commit. If denied: discard. Eliminates surprises.",category:"Security",tags:["speculative","hitl"]},{id:"k-5",title:"RAG Pipeline Architecture",content:"Documents → Chunker → Embedder → Vector Store → Retriever → LLM. Supports PDF, MD, TXT, code. All operations are governed — indexing agents need fs.read capability. PII is redacted before embedding.",category:"RAG",tags:["rag","documents"]}];function ze(){var J,K,Q,Z,ee,te,se;const[n,l]=i.useState("courses"),[g,v]=i.useState(null),[h,j]=i.useState(null),[w,q]=i.useState(""),[d,F]=i.useState({}),[C,z]=i.useState(-1),[T,oe]=i.useState("All"),[u,H]=i.useState(Ee),[de,E]=i.useState(0),[A,he]=i.useState([]),[U,Y]=i.useState(!1),[x,P]=i.useState(null),[D,y]=i.useState([]),[L,I]=i.useState(""),[B,W]=i.useState(!1),[N,X]=i.useState(0),$=i.useRef(null);i.useEffect(()=>{let t=!1;return(async()=>{const s=await De();!t&&s.length>0&&(he(s),Y(!0));const a=await Ie(),o=await Pe(),M={...a,...o};!t&&Object.keys(M).length>0&&(Y(!0),H(fe=>{const R={...fe};for(const[ae,ie]of Object.entries(M))ie!=null&&(R[ae]=Math.max(R[ae]??0,ie));return re(R),R}))})(),()=>{t=!0}},[]),i.useEffect(()=>{re(u)},[u]);const c=i.useMemo(()=>p.find(t=>t.id===g)??null,[g]),r=i.useMemo(()=>f.find(t=>t.id===h)??null,[h]),k=i.useMemo(()=>p.filter(t=>(u[t.id]??0)>=t.steps.length).length,[u]),m=i.useMemo(()=>{var s;let t=0;for(const a of p)(u[a.id]??0)>=a.steps.length&&(t+=a.xp);for(const a of f)((s=d[a.id])==null?void 0:s.status)==="pass"&&(t+=a.xp);return t},[u,d]),S=i.useMemo(()=>{const t=p.reduce((a,o)=>a+o.steps.length,0),s=p.reduce((a,o)=>a+Math.min(u[o.id]??0,o.steps.length),0);return t>0?Math.round(s/t*100):0},[u]),V=i.useMemo(()=>T==="All"?p:p.filter(t=>t.category===T),[T]),ue=i.useCallback((t,s)=>{H(a=>{const o=a[t]??0;return s>=o?{...a,[t]:s+1}:a}),E(s+1),Be(t,String(s))},[]),pe=i.useCallback(async t=>{P(t),X(0),y([]),I("");try{const s=await ve(t),a=typeof s=="string"?s:JSON.stringify(s);y([{role:"system",content:a||"Teach mode started. Follow the prompts below to build step by step."}])}catch{y([{role:"system",content:"Teach mode started (offline). Follow the prompts below to build step by step."}])}},[]),_=i.useCallback(async t=>{if(!x||!t.trim())return;const s={role:"user",content:t.trim()};y(a=>[...a,s]),I(""),W(!0);try{const a=await xe(x,t.trim()),o=typeof a=="string"?a:JSON.stringify(a);y(M=>[...M,{role:"system",content:o||"Step completed. Continue to the next prompt."}])}catch{y(a=>[...a,{role:"system",content:"Response recorded (offline). Continue to the next prompt."}])}W(!1)},[x]);i.useEffect(()=>{var t;(t=$.current)==null||t.scrollIntoView({behavior:"smooth"})},[D]);const me=i.useCallback(async()=>{if(r)try{const t=await ye(r.id,w,"rust"),s=JSON.parse(t);F(a=>({...a,[r.id]:{status:s.passed?"pass":"fail",issues:s.issues??s.errors??void 0,feedback:s.feedback??(s.passed?`Great work! You earned ${r.xp} XP.`:void 0)}}))}catch{F(s=>({...s,[r.id]:{status:"fail",issues:["Could not reach the Nexus OS backend. Make sure the backend is running."]}}))}},[r,w]),ge=i.useCallback(t=>{j(t);const s=f.find(a=>a.id===t);s&&q(s.starterCode),z(-1)},[]);return e.jsxs("div",{className:"lc-container",children:[e.jsxs("aside",{className:"lc-sidebar",children:[e.jsxs("div",{className:"lc-sidebar-header",children:[e.jsx("h2",{className:"lc-sidebar-title",children:"Learning Center"}),e.jsxs("div",{className:"lc-xp-badge",children:["XP ",m]})]}),e.jsx("div",{className:"lc-views",children:[["courses","courses","Courses"],["challenges","challenges","Challenges"],["build","build","Build"],["knowledge","knowledge","Knowledge"],["progress","progress","Progress"]].map(([t,s,a])=>e.jsxs("button",{className:`lc-view-btn cursor-pointer ${n===t?"active":""}`,onClick:()=>{l(t),v(null),j(null),P(null)},children:[e.jsx("span",{children:s==="courses"?e.jsx(Ce,{size:14,"aria-hidden":"true"}):s==="challenges"?e.jsx(Te,{size:14,"aria-hidden":"true"}):s==="build"?e.jsx(Ae,{size:14,"aria-hidden":"true"}):s==="knowledge"?e.jsx(Le,{size:14,"aria-hidden":"true"}):e.jsx(Me,{size:14,"aria-hidden":"true"})})," ",a]},t))}),e.jsxs("div",{className:"lc-progress-card",children:[e.jsx("div",{className:"lc-section-header",children:"Your Progress"}),e.jsx("div",{className:"lc-progress-bar-container",children:e.jsx("div",{className:"lc-progress-bar",style:{width:`${S}%`}})}),e.jsxs("div",{className:"lc-progress-label",children:[S,"% complete"]}),e.jsxs("div",{className:"lc-progress-stats",children:[e.jsxs("div",{className:"lc-stat",children:[e.jsx("span",{children:k}),e.jsx("span",{children:"Completed"})]}),e.jsxs("div",{className:"lc-stat",children:[e.jsx("span",{children:p.length-k}),e.jsx("span",{children:"Remaining"})]}),e.jsxs("div",{className:"lc-stat",children:[e.jsxs("span",{children:[Object.values(d).filter(t=>t.status==="pass").length,"/",f.length]}),e.jsx("span",{children:"Challenges"})]})]})]}),A.length>0&&e.jsxs("div",{className:"lc-progress-card",children:[e.jsx("div",{className:"lc-section-header",children:"Skill Levels"}),A.map(t=>e.jsxs("div",{style:{marginBottom:8},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:"0.8rem",color:"#94a3b8",marginBottom:2},children:[e.jsx("span",{style:{textTransform:"capitalize"},children:t.name.replace(/_/g," ")}),e.jsxs("span",{children:[t.level,"/",t.maxLevel]})]}),e.jsx("div",{className:"lc-progress-bar-container",style:{height:4},children:e.jsx("div",{className:"lc-progress-bar",style:{width:`${t.level/t.maxLevel*100}%`,background:t.level>=4?"#22c55e":t.level>=2?"#f59e0b":"#64748b"}})})]},t.name))]}),e.jsxs("div",{className:"lc-filters",children:[e.jsx("div",{className:"lc-section-header",children:"Filter"}),e.jsx("select",{className:"lc-filter-select",value:T,onChange:t=>oe(t.target.value),children:Oe.map(t=>e.jsx("option",{value:t,children:t},t))})]}),e.jsxs("div",{className:"lc-audit",children:[e.jsx("div",{className:"lc-section-header",children:"Completion"}),p.map(t=>{const s=(u[t.id]??0)>=t.steps.length;return e.jsxs("div",{className:"lc-audit-entry",style:{color:s?"#22c55e":"#94a3b8"},children:[s?e.jsx(O,{size:12,"aria-hidden":"true",style:{display:"inline",verticalAlign:"middle",marginRight:4}}):e.jsx(ne,{size:12,"aria-hidden":"true",style:{display:"inline",verticalAlign:"middle",marginRight:4}})," ",t.title.slice(0,28)]},t.id)})]})]}),e.jsxs("div",{className:"lc-main",children:[n==="courses"&&!g&&e.jsxs("div",{className:"lc-courses",children:[e.jsxs("div",{className:"lc-view-header",children:[e.jsx("h3",{className:"lc-view-title",children:"Courses"}),e.jsxs("span",{className:"lc-view-count",children:[V.length," courses"]})]}),e.jsx("div",{className:"lc-course-grid",children:V.map(t=>{const s=u[t.id]??0,a=s>=t.steps.length;return e.jsxs("div",{className:"lc-course-card",onClick:()=>{v(t.id),E(Math.min(s,t.steps.length-1))},children:[e.jsxs("div",{className:"lc-course-thumb",style:{background:t.thumbnail},children:[e.jsx("span",{className:"lc-course-diff",style:{color:b[t.difficulty]},children:t.difficulty}),a&&e.jsx("span",{style:{position:"absolute",top:8,right:8,color:"#22c55e",fontWeight:700,fontSize:"1.1rem"},children:"COMPLETE"})]}),e.jsxs("div",{className:"lc-course-body",children:[e.jsx("div",{className:"lc-course-title",children:t.title}),e.jsxs("div",{className:"lc-course-desc",children:[t.description.slice(0,100),"..."]}),e.jsxs("div",{className:"lc-course-meta",children:[e.jsx("span",{children:t.category}),e.jsxs("span",{children:["XP ",t.xp]})]}),e.jsxs("div",{className:"lc-course-progress-row",children:[e.jsx("div",{className:"lc-course-progress-bar",children:e.jsx("div",{className:"lc-course-progress-fill",style:{width:`${Math.min(s,t.steps.length)/t.steps.length*100}%`}})}),e.jsxs("span",{className:"lc-course-progress-text",children:[Math.min(s,t.steps.length),"/",t.steps.length]})]}),e.jsx("div",{className:"lc-course-tags",children:t.tags.map(o=>e.jsx("span",{className:"lc-tag",children:o},o))})]})]},t.id)})})]}),n==="courses"&&c&&e.jsxs("div",{className:"lc-course-detail",children:[e.jsx("button",{className:"lc-back-btn",onClick:()=>v(null),children:"← Back to Courses"}),e.jsxs("div",{className:"lc-cd-header",children:[e.jsx("div",{className:"lc-cd-thumb",style:{background:c.thumbnail}}),e.jsxs("div",{className:"lc-cd-info",children:[e.jsx("h3",{className:"lc-cd-title",children:c.title}),e.jsx("div",{className:"lc-cd-desc",children:c.description}),e.jsxs("div",{className:"lc-cd-meta",children:[e.jsx("span",{className:"lc-cd-diff",style:{color:b[c.difficulty]},children:c.difficulty}),e.jsx("span",{children:c.category}),e.jsxs("span",{children:["XP ",c.xp]}),e.jsxs("span",{children:[c.steps.length," steps"]})]}),e.jsxs("div",{className:"lc-cd-progress",children:[e.jsx("div",{className:"lc-cd-progress-bar",children:e.jsx("div",{className:"lc-cd-progress-fill",style:{width:`${Math.min(u[c.id]??0,c.steps.length)/c.steps.length*100}%`}})}),e.jsxs("span",{children:[Math.min(u[c.id]??0,c.steps.length),"/",c.steps.length," completed"]})]})]})]}),e.jsxs("div",{className:"lc-cd-lessons",children:[e.jsx("h4",{children:"Steps"}),c.steps.map((t,s)=>{const a=s<(u[c.id]??0),o=de===s;return e.jsxs("div",{children:[e.jsxs("div",{className:`lc-cd-lesson ${a?"completed":o?"current":""}`,onClick:()=>E(s),style:{cursor:"pointer"},children:[e.jsx("span",{className:"lc-cd-lesson-num",children:a?e.jsx(O,{size:14,"aria-hidden":"true"}):s+1}),e.jsx("span",{className:"lc-cd-lesson-title",children:t.title})]}),o&&e.jsxs("div",{style:{padding:"1rem 1rem 1rem 3rem",borderLeft:"2px solid var(--nexus-accent)33",marginLeft:"0.5rem",marginBottom:"0.5rem"},children:[e.jsx("div",{style:{color:"#e2e8f0",lineHeight:1.7,whiteSpace:"pre-wrap"},children:t.instruction}),t.code&&e.jsx("pre",{style:{background:"#0f172a",padding:"1rem",borderRadius:8,marginTop:"1rem",border:"1px solid #1e293b",overflow:"auto",fontSize:"0.85rem",color:"var(--nexus-accent)"},children:t.code}),t.tip&&e.jsxs("div",{style:{marginTop:"1rem",padding:"0.75rem 1rem",borderRadius:8,background:"#f59e0b11",border:"1px solid #f59e0b33",color:"#f59e0b",fontSize:"0.85rem"},children:["Tip: ",t.tip]}),!a&&e.jsx("button",{className:"lc-start-course-btn",style:{marginTop:"1rem"},onClick:()=>ue(c.id,s),children:s===c.steps.length-1?"Complete Course":"Mark Complete & Next"})]})]},s)})]})]}),n==="challenges"&&e.jsxs("div",{className:"lc-challenges",children:[e.jsxs("div",{className:"lc-view-header",children:[e.jsx("h3",{className:"lc-view-title",children:"Code Challenges"}),e.jsxs("span",{className:"lc-view-count",children:[Object.values(d).filter(t=>t.status==="pass").length,"/",f.length," solved"]})]}),e.jsxs("div",{className:"lc-challenges-grid",children:[e.jsx("div",{className:"lc-challenge-list",children:f.map(t=>{var s,a;return e.jsxs("div",{className:`lc-challenge-item ${h===t.id?"active":""}`,onClick:()=>ge(t.id),children:[e.jsx("div",{className:"lc-ch-status",children:((s=d[t.id])==null?void 0:s.status)==="pass"?e.jsx("span",{className:"lc-ch-pass",children:e.jsx(O,{size:14,"aria-hidden":"true"})}):((a=d[t.id])==null?void 0:a.status)==="fail"?e.jsx("span",{className:"lc-ch-fail",children:e.jsx(Re,{size:14,"aria-hidden":"true"})}):e.jsx("span",{className:"lc-ch-untried",children:e.jsx(ne,{size:14,"aria-hidden":"true"})})}),e.jsxs("div",{className:"lc-ch-info",children:[e.jsx("div",{className:"lc-ch-title",children:t.title}),e.jsxs("div",{className:"lc-ch-meta",children:[e.jsx("span",{style:{color:b[t.difficulty]},children:t.difficulty}),e.jsxs("span",{children:["XP ",t.xp]})]})]})]},t.id)})}),r?e.jsxs("div",{className:"lc-challenge-editor",children:[e.jsxs("div",{className:"lc-ce-header",children:[e.jsx("h4",{children:r.title}),e.jsxs("span",{className:"lc-ce-diff",style:{color:b[r.difficulty]},children:[r.difficulty," · XP ",r.xp]})]}),e.jsx("div",{className:"lc-ce-desc",children:r.description}),e.jsxs("div",{className:"lc-ce-expected",children:[e.jsx("div",{className:"lc-ce-expected-label",children:"Expected Output:"}),e.jsx("pre",{children:r.expectedOutput})]}),e.jsxs("div",{className:"lc-ce-code-area",children:[e.jsxs("div",{className:"lc-ce-code-header",children:[e.jsx("span",{children:"Solution"}),e.jsx("span",{className:"lc-ce-lang",children:"rust"}),e.jsxs("span",{style:{marginLeft:"auto",fontSize:"0.7rem",color:"#64748b"},children:[w.split(`
`).length," lines"]})]}),e.jsxs("div",{style:{display:"flex",position:"relative"},children:[e.jsx("div",{style:{padding:"0.75rem 0.5rem 0.75rem 0.25rem",fontFamily:"monospace",fontSize:"0.8rem",lineHeight:"1.5",color:"#475569",textAlign:"right",userSelect:"none",borderRight:"1px solid #1e293b",background:"rgba(15,23,42,0.5)",minWidth:32,whiteSpace:"pre-wrap"},children:w.split(`
`).map((t,s)=>`${s+1}
`).join("")}),e.jsx("textarea",{className:"lc-ce-textarea",style:{flex:1,borderRadius:"0 0 6px 0"},value:w,onChange:t=>q(t.target.value),spellCheck:!1})]})]}),e.jsxs("div",{className:"lc-ce-actions",children:[e.jsx("button",{className:"lc-ce-run",onClick:me,children:"Run & Check"}),r.hints.map((t,s)=>e.jsxs("button",{className:"lc-ce-hint",onClick:()=>z(C===s?-1:s),children:["Hint ",s+1]},s))]}),C>=0&&C<r.hints.length&&e.jsx("div",{className:"lc-ce-hint-box",children:r.hints[C]}),((J=d[r.id])==null?void 0:J.status)==="pass"&&e.jsxs("div",{className:"lc-ce-result lc-ce-result-pass",children:["All tests passed! +",r.xp," XP"]}),((K=d[r.id])==null?void 0:K.status)==="fail"&&e.jsx("div",{className:"lc-ce-result lc-ce-result-fail",children:"Tests failed — check your logic and try again."}),((Q=d[r.id])==null?void 0:Q.status)==="fail"&&e.jsxs("div",{style:{marginTop:8,padding:"8px 12px",background:"rgba(251,191,36,0.05)",border:"1px solid rgba(251,191,36,0.2)",borderRadius:6,fontSize:"0.75rem"},children:[e.jsx("div",{style:{fontWeight:600,marginBottom:4,color:"#fbbf24"},children:"Hints:"}),((ee=(Z=d[r.id])==null?void 0:Z.issues)==null?void 0:ee.map((t,s)=>e.jsxs("div",{style:{opacity:.7,paddingLeft:8,marginBottom:2},children:["• ",t]},s)))||e.jsx("div",{style:{opacity:.7},children:"Review the requirements and try again."})]}),((te=d[r.id])==null?void 0:te.status)==="pass"&&e.jsxs("div",{style:{marginTop:8,padding:"8px 12px",background:"rgba(34,197,94,0.05)",border:"1px solid rgba(34,197,94,0.2)",borderRadius:6,fontSize:"0.75rem"},children:[e.jsx("div",{style:{fontWeight:600,color:"#22c55e"},children:"Challenge Passed!"}),e.jsx("div",{style:{opacity:.7,marginTop:2},children:((se=d[r.id])==null?void 0:se.feedback)??"Well done!"})]})]}):e.jsxs("div",{className:"lc-ce-empty",children:[e.jsx("div",{className:"lc-ce-empty-icon",children:">_"}),e.jsx("div",{children:"Select a challenge to begin"})]})]})]}),n==="knowledge"&&e.jsxs("div",{className:"lc-knowledge",children:[e.jsxs("div",{className:"lc-view-header",children:[e.jsx("h3",{className:"lc-view-title",children:"Knowledge Base"}),e.jsxs("span",{className:"lc-view-count",children:[le.length," articles"]})]}),e.jsx("div",{className:"lc-kb-list",children:le.map(t=>e.jsxs("div",{className:"lc-kb-card",children:[e.jsxs("div",{className:"lc-kb-header",children:[e.jsx("div",{className:"lc-kb-title",children:t.title}),e.jsx("div",{className:"lc-kb-meta",children:e.jsx("span",{children:t.category})})]}),e.jsx("div",{className:"lc-kb-content",style:{whiteSpace:"pre-wrap"},children:t.content}),e.jsx("div",{className:"lc-kb-tags",children:t.tags.map(s=>e.jsx("span",{className:"lc-tag",children:s},s))})]},t.id))})]}),n==="build"&&!x&&e.jsxs("div",{className:"lc-courses",children:[e.jsxs("div",{className:"lc-view-header",children:[e.jsx("h3",{className:"lc-view-title",children:"Learn by Building"}),e.jsxs("span",{className:"lc-view-count",children:[G.length," projects"]})]}),e.jsx("p",{style:{color:"#94a3b8",marginBottom:"1rem",fontSize:"0.9rem"},children:"Hands-on projects using teach mode. The backend guides you step by step as you build real Nexus OS features."}),e.jsx("div",{className:"lc-course-grid",children:G.map(t=>e.jsxs("div",{className:"lc-course-card",onClick:()=>pe(t.id),children:[e.jsx("div",{className:"lc-course-thumb",style:{background:"linear-gradient(135deg, #0f172a 0%, #6366f1 100%)"},children:e.jsx("span",{className:"lc-course-diff",style:{color:b[t.difficulty]},children:t.difficulty})}),e.jsxs("div",{className:"lc-course-body",children:[e.jsx("div",{className:"lc-course-title",children:t.title}),e.jsx("div",{className:"lc-course-desc",children:t.description}),e.jsxs("div",{className:"lc-course-meta",children:[e.jsx("span",{children:t.category}),e.jsxs("span",{children:["XP ",t.xp]}),e.jsxs("span",{children:[t.prompts.length," steps"]})]})]})]},t.id))})]}),n==="build"&&x&&(()=>{const t=G.find(s=>s.id===x);return t?e.jsxs("div",{className:"lc-course-detail",children:[e.jsx("button",{className:"lc-back-btn",onClick:()=>P(null),children:"← Back to Projects"}),e.jsxs("div",{className:"lc-cd-header",children:[e.jsx("div",{className:"lc-cd-thumb",style:{background:"linear-gradient(135deg, #0f172a 0%, #6366f1 100%)"}}),e.jsxs("div",{className:"lc-cd-info",children:[e.jsx("h3",{className:"lc-cd-title",children:t.title}),e.jsx("div",{className:"lc-cd-desc",children:t.description}),e.jsxs("div",{className:"lc-cd-meta",children:[e.jsx("span",{className:"lc-cd-diff",style:{color:b[t.difficulty]},children:t.difficulty}),e.jsx("span",{children:t.category}),e.jsxs("span",{children:["XP ",t.xp]})]})]})]}),e.jsxs("div",{style:{margin:"1rem 0"},children:[e.jsx("h4",{style:{color:"#e2e8f0",marginBottom:"0.5rem"},children:"Steps"}),t.prompts.map((s,a)=>e.jsxs("div",{className:`lc-cd-lesson ${a<N?"completed":a===N?"current":""}`,style:{cursor:a===N?"pointer":"default"},onClick:()=>{a===N&&(X(a+1),_(s))},children:[e.jsx("span",{className:"lc-cd-lesson-num",children:a<N?e.jsx(O,{size:14,"aria-hidden":"true"}):a+1}),e.jsx("span",{className:"lc-cd-lesson-title",children:s})]},a))]}),e.jsxs(Se,{feature:"AI Teach Mode",children:[e.jsxs("div",{style:{background:"#0f172a",border:"1px solid #1e293b",borderRadius:8,padding:"1rem",maxHeight:320,overflowY:"auto",marginBottom:"1rem"},children:[D.length===0&&e.jsx("div",{style:{color:"#64748b",textAlign:"center",padding:"2rem 0"},children:"Click a step above or type below to start the teach-mode conversation."}),D.map((s,a)=>e.jsxs("div",{style:{marginBottom:8,padding:"0.5rem 0.75rem",borderRadius:6,background:s.role==="user"?"#1e293b":"transparent",borderLeft:s.role==="system"?"2px solid var(--nexus-accent)":"none"},children:[e.jsx("div",{style:{fontSize:"0.7rem",color:"#64748b",marginBottom:2},children:s.role==="user"?"You":"Nexus Teach Mode"}),e.jsx("div",{style:{color:"#e2e8f0",fontSize:"0.85rem",whiteSpace:"pre-wrap"},children:s.content})]},a)),B&&e.jsx("div",{style:{color:"#64748b",fontSize:"0.85rem",padding:"0.25rem 0.75rem"},children:"Thinking..."}),e.jsx("div",{ref:$})]}),e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx("input",{style:{flex:1,background:"#1e293b",border:"1px solid #334155",borderRadius:6,padding:"0.5rem 0.75rem",color:"#e2e8f0",fontSize:"0.85rem",outline:"none"},placeholder:"Type your response or describe what you built...",value:L,onChange:s=>I(s.target.value),onKeyDown:s=>{s.key==="Enter"&&!s.shiftKey&&(s.preventDefault(),_(L))},disabled:B}),e.jsx("button",{className:"lc-start-course-btn",onClick:()=>_(L),disabled:B||!L.trim(),children:"Send"})]})]})]}):null})(),n==="progress"&&e.jsxs("div",{className:"lc-progress-view",children:[e.jsx("div",{className:"lc-view-header",children:e.jsx("h3",{className:"lc-view-title",children:"Your Learning Progress"})}),e.jsxs("div",{className:"lc-pv-hero",children:[e.jsxs("div",{className:"lc-pv-xp",children:[e.jsxs("div",{className:"lc-pv-xp-number",children:["XP ",m]}),e.jsx("div",{className:"lc-pv-xp-label",children:"Total XP"})]}),e.jsxs("div",{className:"lc-pv-level",children:[e.jsxs("div",{className:"lc-pv-level-badge",children:["Level ",Math.floor(m/500)+1]}),e.jsx("div",{className:"lc-pv-level-title",children:m<500?"Apprentice":m<1e3?"Practitioner":m<2e3?"Engineer":m<4e3?"Architect":"Master"}),e.jsx("div",{className:"lc-pv-level-bar",children:e.jsx("div",{className:"lc-pv-level-fill",style:{width:`${m%500/5}%`}})}),e.jsxs("div",{className:"lc-pv-level-next",children:[500-m%500," XP to next level"]})]})]}),e.jsxs("div",{className:"lc-pv-stats",children:[e.jsxs("div",{className:"lc-pv-stat-card",children:[e.jsxs("div",{className:"lc-pv-stat-value",children:[S,"%"]}),e.jsx("div",{className:"lc-pv-stat-label",children:"Course Completion"}),e.jsx("div",{className:"lc-pv-stat-bar",children:e.jsx("div",{style:{width:`${S}%`,background:"var(--nexus-accent)",height:"100%",borderRadius:2}})})]}),e.jsxs("div",{className:"lc-pv-stat-card",children:[e.jsxs("div",{className:"lc-pv-stat-value",children:[k,"/",p.length]}),e.jsx("div",{className:"lc-pv-stat-label",children:"Courses Completed"}),e.jsx("div",{className:"lc-pv-stat-bar",children:e.jsx("div",{style:{width:`${k/p.length*100}%`,background:"#22c55e",height:"100%",borderRadius:2}})})]}),e.jsxs("div",{className:"lc-pv-stat-card",children:[e.jsxs("div",{className:"lc-pv-stat-value",children:[Object.values(d).filter(t=>t.status==="pass").length,"/",f.length]}),e.jsx("div",{className:"lc-pv-stat-label",children:"Challenges Solved"}),e.jsx("div",{className:"lc-pv-stat-bar",children:e.jsx("div",{style:{width:`${Object.values(d).filter(t=>t.status==="pass").length/f.length*100}%`,background:"#f59e0b",height:"100%",borderRadius:2}})})]})]}),A.length>0&&e.jsxs(e.Fragment,{children:[e.jsx("h4",{className:"lc-sub-title",children:"Skill Levels"}),e.jsx("div",{className:"lc-pv-stats",style:{marginBottom:"1.5rem"},children:A.map(t=>e.jsxs("div",{className:"lc-pv-stat-card",children:[e.jsxs("div",{className:"lc-pv-stat-value",children:[t.level,"/",t.maxLevel]}),e.jsx("div",{className:"lc-pv-stat-label",style:{textTransform:"capitalize"},children:t.name.replace(/_/g," ")}),e.jsx("div",{className:"lc-pv-stat-bar",children:e.jsx("div",{style:{width:`${t.level/t.maxLevel*100}%`,background:t.level>=4?"#22c55e":t.level>=2?"#f59e0b":"#6366f1",height:"100%",borderRadius:2}})})]},t.name))})]}),e.jsx("h4",{className:"lc-sub-title",children:"Course Progress"}),e.jsx("div",{className:"lc-pv-courses",children:p.map(t=>{const s=Math.min(u[t.id]??0,t.steps.length),a=s>=t.steps.length;return e.jsxs("div",{className:"lc-pv-course-row",children:[e.jsxs("div",{className:"lc-pv-course-info",children:[e.jsx("span",{className:"lc-pv-course-name",children:t.title}),e.jsx("span",{className:"lc-pv-course-status",style:{color:a?"#22c55e":s>0?"#f59e0b":"#64748b"},children:a?"Complete":s>0?"In Progress":"Not Started"})]}),e.jsxs("div",{className:"lc-pv-course-bar-row",children:[e.jsx("div",{className:"lc-pv-course-bar",children:e.jsx("div",{className:"lc-pv-course-fill",style:{width:`${s/t.steps.length*100}%`}})}),e.jsxs("span",{className:"lc-pv-course-pct",children:[Math.round(s/t.steps.length*100),"%"]})]})]},t.id)})})]})]}),e.jsxs("div",{className:"lc-status-bar",children:[e.jsxs("span",{className:"lc-status-item",children:["XP ",m]}),e.jsxs("span",{className:"lc-status-item",children:["Level ",Math.floor(m/500)+1]}),e.jsxs("span",{className:"lc-status-item",children:[k,"/",p.length," courses"]}),e.jsxs("span",{className:"lc-status-item",children:[Object.values(d).filter(t=>t.status==="pass").length,"/",f.length," challenges"]}),e.jsxs("span",{className:"lc-status-item",children:[S,"% progress"]}),e.jsx("span",{className:"lc-status-item lc-status-right",style:{color:U?"#22c55e":"#f59e0b"},children:U?"backend synced":"localStorage (offline)"})]})]})}export{ze as default};
